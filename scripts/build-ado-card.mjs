...
function renderSvg({ commits, prs, workItems, contributed }) {
  ...
  const icons = {
    commit:
      `<path d="M10.86 19.47a4.5 4.5 0 1 0 0-2.94H1.5a.75.75 0 0 0 0 1.5h9.36ZM12 18a3 3 0 1 1 6 0 3 3 0 0 1-6 0ZM13.14 5.47a4.5 4.5 0 1 0 0-2.94H1.5a.75.75 0 0 0 0 1.5h11.64ZM14.25 4a3 3 0 1 1 6 0 3 3 0 0 1-6 0Z" fill="#58a6ff"/>`,
    pr:
      `<path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z" fill="#58a6ff"/>`,
    issue:
      `<path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z" fill="#58a6ff"/><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0Zm0 1.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13Z" fill="#58a6ff"/>`,
    repo:
  ...
  <g transform="translate(25, ${y})">
    ...
    <text x="25" y="0" fill="#f0f6fc" font-size="14">${r.label}:</text>
    <text x="220" y="0" fill="#f0f6fc" font-size="14" font-weight="600" text-anchor="end">${r.value.toLocaleString()}</text>
  </g>`;
    })
    .join("");
